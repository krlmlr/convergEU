...
head(emp_20_64)
```
Alternatively, a dataframe obtained by  reshaping raw data into a time by countries
table is also available and typically more usefull:
```{r,eval=FALSE}
...
Below this behaviour is illustrated
...
Now we permutate values and calculate gamma-convergence:
```{r}
...
Indeed there is the possbility of performing calculation
...
At the begining and end of this series values are averages on
